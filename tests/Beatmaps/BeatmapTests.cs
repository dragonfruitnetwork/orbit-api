...
namespace DragonFruit.Orbit.Api.Tests.Beatmaps
{
    ...
    public class BeatmapTests : OrbitApiTest
    {
        ...
        public void TestBeatmapLookupByHash(string hash, uint expectedId)
        {
            var mapInfo = Client.GetBeatmapByHash(hash);
        ...
        public void TestBeatmapScoreLookup(uint mapId, GameMode mode, uint expectedUser)
        {
            var globalBests = Client.GetScores(mapId, mode, BeatmapLeaderboardType.Global);
