...
namespace DragonFruit.Orbit.Api.Legacy.Extensions
{
    public static class OsuLegacyScoreExtensions
    {
        ...
        public static IEnumerable<OsuLegacyScore> GetLegacyBeatmapScores<T>(this T client, uint mapId, GameMode? mode = null, uint? limit = null) where T :  ApiClient, ILegacyOrbitClient
        {
        ...
        public static OsuLegacyReplayContent GetBeatmapReplay<T>(this T client, uint mapId, string identifier, GameMode mode, LegacyMods? mods = null, bool? isUsername = null) where T :  ApiClient, ILegacyOrbitClient
        {
            ...
            return client.Perform<OsuLegacyReplayContent>(request);
        }
        ...
        /// <returns>Container for the Base64 encoded replay. This is not the .osr file, but just the input data (key/mouse)</returns>
        public static OsuLegacyReplayContent GetBeatmapReplay<T>(this T client, ulong scoreId) where T :  ApiClient, ILegacyOrbitClient
        {
            var request = new OsuLegacyReplayRequest
            {
                ScoreId = scoreId
